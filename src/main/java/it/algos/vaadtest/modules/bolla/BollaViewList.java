...
@Route(value = TAG_BOL, layout = MainLayout.class)
@Qualifier(TAG_BOL)
@Slf4j
@AIScript(sovrascrivibile = true)
public class BollaViewList extends AViewList {


    /**
     * Icona visibile nel menu (facoltativa)
     */
    public static final VaadinIcon VIEW_ICON = VaadinIcon.PHONE;
     ...
     */
    @Autowired
    public BollaViewList(@Qualifier(TAG_BOL) IAPresenter presenter, @Qualifier(TAG_BOL) IADialog dialog) {
        super(presenter, dialog);
        ((BollaViewDialog) dialog).fixFunzioni(this::save, this::delete);
